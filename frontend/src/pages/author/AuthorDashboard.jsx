    ...
    >
      ...
      >
        <div className="space-y-2 relative z-10">
          <span className="text-[10px] font-mono uppercase tracking-[0.2em] text-[#7B021D] font-bold block flex items-center gap-1.5">
        ...
        <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} className="relative z-10 shrink-0">
          <Link
            to="/author/upload"
            className="px-6 py-3.5 rounded-full bg-[#7B021D] text-[#F5F5DA] text-xs font-mono font-bold uppercase tracking-wider hover:bg-[#520014] transition-colors shadow-md flex items-center gap-2"
          >
      ...
      <motion.div variants={itemVariants} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <motion.div
          ...
          className="p-6 rounded-3xl bg-gradient-to-br from-[#FFFDF3] to-[#F4EEEA] border border-[#E7D9D3] shadow-md hover:shadow-lg hover:shadow-[#7B021D]/10 transition-all space-y-2"
        >
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-mono uppercase tracking-widest text-[#7B021D] font-bold">
              Total Books
            </span>
            <BookOpen className="w-4 h-4 text-[#7B021D]" />
          </div>
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <Star className="w-4 h-4 text-[#7B021D] fill-[#7B021D]" />
          </div>
      ...
      <motion.div variants={itemVariants} className="space-y-4 pt-2">
        <div className="flex items-center justify-between border-b border-[#E7D9D3] pb-4">
          <h3 className="font-editorial-serif text-xl font-bold text-[#2B2B2B] flex items-center gap-2">
            <Activity className="w-4.5 h-4.5 text-[#7B021D]" />
          ...
          {derivedActivity.map((act, i) => (
            ...
            >
              <span className="text-[#2B2B2B] font-sans leading-relaxed flex items-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-[#7B021D] shrink-0" />
                {act.title}
              </span>
