          ...
          return (
            ...
            >
              <Link
                ...
                className="p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-transparent hover:bg-[#F8F6E5] transition-colors group cursor-pointer block"
              >
                <div className="flex items-center gap-4">
                  <img
                    ...
                    className="w-12 h-12 rounded-full object-cover border-2 border-[#E9E5C8] shadow-2xs group-hover:border-[#212842] transition-colors shrink-0"
                  />
                  <div>
