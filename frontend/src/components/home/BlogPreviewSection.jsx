...
export default function BlogPreviewSection() {
  ...
  return (
    <section className="py-24 bg-[#F4EEEA] border-t border-[#E7D9D3]">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div>
            ...
            <h2 className="font-editorial-serif text-4xl text-[#2B2B2B] font-normal tracking-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {posts.map((post, idx) => (
            ...
            >
              <Link
                to="/blog"
                className="bg-[#FFFFFF] rounded-2xl p-6 border border-[#E7D9D3] shadow-sm flex flex-col justify-between h-full hover:border-[#D3968C] transition-all duration-300 group block"
              >
                <div className="space-y-3">
                  <div className="flex items-center justify-between text-[11px] font-mono text-[#6E6A67]">
                    <span>{post.date}</span>
                    <span className="text-[#D3968C]">{post.readTime}</span>
                  </div>

                  <h3 className="font-editorial-serif text-xl font-bold text-[#2B2B2B] group-hover:text-[#C98579] transition-colors">
                    {post.title}
                  </h3>
                ...
                <div className="pt-4 mt-6 border-t border-[#E7D9D3] flex items-center justify-end text-xs font-mono text-[#2B2B2B] group-hover:text-[#D3968C] transition-colors">
