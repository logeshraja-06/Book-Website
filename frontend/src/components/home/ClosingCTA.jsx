...
export default function ClosingCTA() {
  return (
    <section className="py-24 bg-[#F5F5DA] border-t border-[#E9E5C8] relative overflow-hidden">
      ...
      {/* Soft Ambient Blob */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[350px] bg-[#7B021D]/[0.06] blur-3xl rounded-full pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        <div className="bg-[#FFFDF3] rounded-3xl p-10 sm:p-16 border border-[#E9E5C8] shadow-sm grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-4 flex flex-col sm:flex-row lg:flex-col gap-4">
            ...
            <Link
              to="/books"
              className="w-full inline-flex items-center justify-center gap-3 px-8 py-4 rounded-full bg-[#7B021D] text-[#F5F5DA] text-sm font-bold tracking-wide hover:bg-[#520014] transition-all duration-300 shadow-md group"
            >
            ...
            <Link
              to="/authors"
              className="w-full inline-flex items-center justify-center gap-2.5 px-8 py-4 rounded-full bg-[#F5F5DA] border border-[#E9E5C8] text-[#211D1D] text-sm font-medium hover:border-[#7B021D] hover:bg-[#FFFDF3] transition-all duration-300"
            >
