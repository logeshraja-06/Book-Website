    ...
    <div className="bg-[#FFFDF3] border-y border-[#E9E5C8] py-6 shadow-2xs">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          <div>
            <span className="text-[11px] font-mono uppercase tracking-[0.16em] text-[#7B021D] font-bold block">
              Quick Discovery
            </span>
            ...
            return (
              <button
                ...
                className={`px-4 py-2 rounded-full text-xs font-editorial-sans font-bold whitespace-nowrap transition-all duration-250 ${
                  isSelected
                    ? 'bg-[#7B021D] text-[#F5F5DA] shadow-2xs'
                    : 'bg-[#F5F5DA] border border-[#E9E5C8] text-[#211D1D] hover:border-[#7B021D]'
                }`}
              >
                {g}
              </button>
        ...
        <div className="flex items-center gap-3 shrink-0">
          <button
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#211D1D] text-[#F5F5DA] text-xs font-editorial-sans font-bold uppercase tracking-wider hover:bg-[#7B021D] transition-colors"
          >
