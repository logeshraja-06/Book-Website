  ...
  return (
    <div className="min-h-screen bg-[#F5F5DA] text-[#181616] selection:bg-[#212842] selection:text-[#F5F5DA] relative">
      ...
      <header className="bg-[#211D1D] text-[#F5F5DA] border-b border-[#D8CFAE]/20 pt-8 pb-6 relative overflow-hidden shadow-xl">
        ...
        <div className="absolute top-0 right-1/4 w-80 h-80 bg-[#212842]/20 blur-3xl rounded-full pointer-events-none" />

        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-6">
            <div className="flex items-center gap-4">
              <div className="w-11 h-11 rounded-full bg-[#181E33] border border-[#D8CFAE]/30 flex items-center justify-center text-[#F5F5DA] shadow-md">
          ...
          <nav className="flex items-center gap-8 border-b border-[#D8CFAE]/15 -mb-6 overflow-x-auto pb-3 scrollbar-none">
            {navItems.map((item) => {
              ...
              return (
                ...
                >
                  <Icon className={`w-4 h-4 ${isActive ? 'text-[#212842]' : 'text-[#D8CFAE]/60'}`} />
